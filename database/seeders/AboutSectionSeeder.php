...
class AboutSectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        AboutSection::create([
            ...
            'desc_ar' => 'نقدم خدمات متنوعة تشمل المقاولات العامة، أعمال التكييف والتبريد،  التصميم الداخلي والديكور، دراسات الجدوى والإستشارات الإدارية، تطوير المواقع والتطبيقات، وحلول التخزين والنقل المبرد. نعمل على توفير حلول مبتكرة وفعّالة لمساعدتك في تحقيق أهدافك من خلال استراتيجيات متكاملة وأحدث التقنيات في مختلف القطاعات لضمان نجاح مشروعك واستدامته.',
        ]);
        AboutSection::create([
            
            'title_en' => 'Latest technology',
            'title_ar' => 'أحدث التقنيات',
            'desc_en' => 'We use the latest technologies in artificial intelligence, machine learning, and cloud computing to grow your business. We also rely on advanced security systems to protect your data. We use big data analytics techniques to improve performance and provide customized solutions. We ensure that your goals are achieved through innovation and advanced technology.',
            'desc_ar' => 'نستخدم أحدث التقنيات في الذكاء الاصطناعي، تعلم الآلة، وتقنيات الحوسبة السحابية لتطويرأعمالك. كما نعتمد على أنظمة أمان متقدمة لحماية بياناتك. نستخدم تقنيات تحليل البيانات الكبيرة لتحسين الأداء وتقديم حلول مخصصة. نضمن تحقيق أهدافك من خلال الابتكار والتكنولوجيا المتطورة.',
        ]);
        AboutSection::create([
            ...
            'desc_ar' => 'نقدم حلولًا فريدة من نوعها تشمل أنظمة تكييف متقدمة، خدمات دراسات الجدوى المخصصة، وتصميمات داخلية مبتكرة. ندمج التكنولوجيا الحديثة مع الخبرة العملية لتوفير حلول مصممة خصيصًا لتلبية احتياجاتك، مما يضمن تحقيق أعلى مستويات الكفاءة والنجاح في جميع جوانب عملك.',
        ]);
        AboutSection::create([
            
            'title_en' => 'Powerful strategies',
            'title_ar' => 'استراتيجيات قوية',
            'desc_en' => 'We rely on strong strategies based on a comprehensive analysis of the market and environment, which helps in making informed decisions to improve performance and achieve growth. Through strategic planning and implementing effective solutions, we ensure that you achieve your goals efficiently, while ensuring sustainability and excellence in the competitive business environment.',
            'desc_ar' => 'نعتمد على استراتيجيات قوية مبنية على تحليل شامل للسوق والبيئة، مما يساعد في اتخاذ قرارات مدروسة لتحسين الأداء وتحقيق النمو. من خلال التخطيط الاستراتيجي وتنفيذ الحلول الفعالة، نضمن لك تحقيق أهدافك بكفاءة، مع ضمان الاستدامة والتفوق في بيئة العمل التنافسية.',
        ]);
    }
}
