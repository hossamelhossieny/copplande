<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold">copplande</span>
        </a>
        ...
        <!-- Page -->
            ...
            <li class="menu-item active">
                <a href="{{ route('customer.dashboard') }}" class="menu-link">
                    <i class="menu-icon tf-icons ti ti-smart-home"></i>
                    <div data-i18n="Dashboard">Customer Dashboard</div>
                </a>
            </li>
            ...
            <li class="menu-item active">
                <a href="{{ route('manager.dashboard') }}" class="menu-link">
                    <i class="menu-icon tf-icons ti ti-smart-home"></i>
                    <div data-i18n="Dashboard">Manager Dashboard</div>
                </a>
            @else
            <li class="menu-item active">
